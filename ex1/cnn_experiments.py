...
from cifar_loader import prepare_cifar_data, PCA_whitened_images, ZCA_whitened_images
...
def grid_search(epochs=10):
    ...
    X_train, y_train, X_test, y_test, class_names = prepare_cifar_data(dataset_dir, cache_dir,
                                                                       subsample_fraction,
                                                                       keep_as_image=True)
...
def optimization(epochs=10):
    ...
    X_train, y_train, X_test, y_test, class_names = (
        prepare_cifar_data(dataset_dir, cache_dir, subsample_fraction, keep_as_image=True))
